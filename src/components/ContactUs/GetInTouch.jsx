    ...
    <div className="relative min-h-screen md:pt-24 mt-24">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 md:px-0">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 pb-8">
          {/* Card 1: Social Media */}
          <div className="bg-white p-6 rounded-xl border border-[#A6A6A6] text-start w-full max-w-xs">
          ...
          {/* Card 2: Chat Support */}
          <div className="bg-white p-6 rounded-xl border border-[#A6A6A6] text-left w-full max-w-xs">
            <div className="flex justify-start mb-4">
              <img
                src="/chaticon.png"
                alt="Chat Icon"
          ...
          <div className="bg-white p-6 rounded-xl border border-[#A6A6A6] text-left w-full max-w-xs">
            ...
            <p className="mt-2 font-semibold text-black">hi@amd.com</p>
          </div>
        </div>
      </div>
    </div>
