  ...
  return (
    <div className="bg-white p-6">
      ...
      <div className="overflow-x-auto md:overflow-visible">
        <div className="flex md:grid md:grid-cols-5 gap-4 md:gap-x-40 px-4 md:px-0 overflow-x-scroll scrollbar-hide">
...
export default CareerBusinessBefore;
