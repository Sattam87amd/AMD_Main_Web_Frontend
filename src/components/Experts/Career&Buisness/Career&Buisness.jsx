...
const CareerBuisnessExperts = () => {
  return (
    <div className="bg-white py-10 px-4">
      {/* Header Section */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        <div>
          <h1 className="text-4xl font-bold">Career & Buisness Expert</h1>
          <p className="text-gray-500 ml-52 mb-10"> Connect with CEOs, executives, coaches, and more   </p>
        </div>
      </div>
...
export default CareerBuisnessExperts;
