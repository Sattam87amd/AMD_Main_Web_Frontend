...
const toggleLoginMethod = () => {
    ...
    const generateOtp = async () => {
        if (useEmail) {
          ...
          try {
            await axios.post("http://amd-api.code4bharat.com/api/expertauth/request-otp", { email });
          ...
          try {
            await axios.post("http://amd-api.code4bharat.com/api/expertauth/request-otp", { phone });
      ...
      const handleSubmit = async () => {
        ...
        try {
          ...
          const response = await axios.post("http://amd-api.code4bharat.com/api/expertauth/verify-otp", payload);
