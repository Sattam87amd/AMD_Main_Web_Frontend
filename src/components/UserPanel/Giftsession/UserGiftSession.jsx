...
function UserGiftSession() {
  ...
  const handleContinue = () => {
    router.push("/userpanel/buygiftsession");
  };
  ...
  const renderGiftCard = () => (
    <div className="w-full bg-white p-6 rounded-xl md:border mx-1 md:mx-10 relative">
      ...
      <div className="mt-6 flex justify-center pb-8">
        <button
          className="w-56 bg-black text-white py-3 rounded-2xl font-normal "
...
export default UserGiftSession;
