          ...
          <div className="grid grid-cols-2 gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <ul className="text-gray-700 text-sm md:text-lg">
                <li className="mb-2">
                  <Link href="/userpanel/ourmission" className="hover:underline">
                    About
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="/userpanel/faQ" className="hover:underline">
                    FAQ
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="/userpanel/giftsession" className="hover:underline">
                    Gift a Session
                  </Link>
                </li>
                <li>
                  <Link href="/userpanel/experts" className="hover:underline">
                    Experts
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="text-gray-700 text-sm md:text-lg">
                <li className="mb-2">
                  <Link href="/userpanel/contactus" className="hover:underline">
                    Contact
                  </Link>
                </li>
                <li className="mb-2">
