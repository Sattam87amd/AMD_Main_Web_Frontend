 ...
 const toggleLoginMethod = () => {
    ...
    const generateOtp = async () => {
        if (useEmail) {
            ...
            try {
                await axios.post("http://amd-api.code4bharat.com/api/userauth/request-otp", { email });
            ...
            try {
                await axios.post("http://amd-api.code4bharat.com/api/userauth/request-otp", { phone });
     ...
     const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post("http://amd-api.code4bharat.com/api/userauth/verify-otp", payload);
