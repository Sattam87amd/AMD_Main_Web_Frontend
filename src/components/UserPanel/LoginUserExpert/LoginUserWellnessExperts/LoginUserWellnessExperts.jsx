...
const LoginUserWellnessExperts = () => {
  return (
        ...
        {repeatedExperts.map((expert, index) => (
          ...
          >
            ...
            <div className="relative w-full h-70">
              ...
              <motion.div
                className="absolute bottom-0 -left-4 w-44 h-28 ml-6 mb-2 bg-white/30 backdrop-blur-lg p-4 rounded-xl text-black"
                initial={{ opacity: 0 }}
...
export default LoginUserWellnessExperts;
