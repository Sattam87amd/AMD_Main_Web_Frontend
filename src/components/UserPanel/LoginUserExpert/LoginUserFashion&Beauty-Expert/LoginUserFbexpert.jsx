    ...
    <div className="bg-white py-10 px-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center">
          {isMobile && (
            <p className="text-gray-500 mb-2 sm:mb-0"> Access to the best experts has never been easier </p>
          )}
          <button
        ...
        {visibleExperts.map((expert, index) => (
          ...
          >
            ...
            <div className="relative w-full h-70">
              ...
              <div className="absolute bottom-0 -left-4 w-52 h-28 ml-6 mb-2 bg-white/30 backdrop-blur-lg p-4 rounded-xl text-black">
