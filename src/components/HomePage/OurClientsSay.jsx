    ...
    <div className="bg-[#EDECE8] py-10 px-4 md:px-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-0 left-0 bg-white w-[400px] h-[200px] text-black text-[55px] text-center font-semibold px-4 py-2 rounded-br-3xl ">
            <h1> What Our <br />
             Clients Say</h1>
          </div>
...
<div>
  <div className="space-y-6">
    {reviews.map((review, index) => (
      <div
        key={index}
        className="bg-[#F8F7F3] text-black p-6 rounded-3xl shadow-lg md:h-56"
      >
        {/* Rating Stars */}
