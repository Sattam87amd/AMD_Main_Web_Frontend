...
const FashionBeautyHomeCards = () => {
  return (
    <div className="bg-white p-6">
      {/* Heading Section */}
      <div className="flex flex-col md:flex-row md:h-40 items-center mb-6">
        <h1 className="text-[60px] font-bold text-black">FASHION & BEAUTY.</h1>
        <p className="text-[#9C9C9C] text-sm md:text-2xl md:ml-10 md:mt-5">
...
export default FashionBeautyHomeCards;
